...
<body>
	...
	<div id="background">
		...
		<div class="container" id="box" style="border: 1px solid white; background: white; border-radius: 10px; width: 1000px; height: 100%; padding: 3%;">
			<h2 style="border-left: 7px solid #65B741; padding-left: 15px; font-weight: bold;">공지사항 글 수정</h2>
			...
			<div class="container" style="padding: 3%;">
				<form>	
					...
					<div class="mb-3" style="display: inline-block; width: 75%; float: right;">
						<input type="text" class="form-control" name="title"  id="title" placeholder="제목을 입력해주세요." value="힐링 동물원 공지사항">
					</div>
					<!-- 글 제목 -->
					...
					<div class="mb-3" style="padding-top: 3%">
						<textarea class="form-control" id="board" style="width: 100%; height: 700px;" placeholder="내용을 입력하세요." >

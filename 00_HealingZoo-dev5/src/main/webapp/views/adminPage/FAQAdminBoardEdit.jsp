...
<body>
	...
	<%@ include file='../common/adminSidebar.jsp'%>
		...
		<div class="container" id="box"
			...
			<h2
				style="border-left: 7px solid #65B741; padding-left: 15px; font-weight: bold;">자주 묻는 Q&A</h2>
			<div
			...
			<div class="container" style="padding: 3%;">
				<form >
					...
					<div class="mb-3"
						...
						<input type="text" class="form-control" name="title" id="title" value="동물원의 운영시간은 어떻게 되나요?" readonly >
					</div>
					<!-- 글 제목 -->
					...
					<div class="mb-3" style="padding-top: 3%">
						<textarea class="form-control" id="board"
							style="width: 100%; height: 700px;" readonly>저희 동물원의 운영시간은 다음과 같습니다. :
평일:오전 9시~오후6시
주말 및 공휴일: 오전9시 ~ 오후 7</textarea>
					</div>
					<!-- 글 내용 -->

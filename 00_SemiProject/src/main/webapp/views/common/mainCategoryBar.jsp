...
<body>
	<div class="container-fluid text-center">
		<div class="row" id='mainCategoryBar'>
			<div class="col">
				<br>
				<br> <a href='${ contextPath }/views/zooInfo/greeting.jsp'
					class='mainCateName' id='zooInfo'>동물원 소개</a>
				<div class="subCategory" id='zooInfoSub'>
					<ul>
						...
						<li style='width: 80px;'><a
							href='${ contextPath }/views/zooInfo/notice.jsp'>공지사항</a></li>
					</ul>
				</div>
			</div>
			<div class="col">
				<br>
				<br> <a href='#' class='mainCateName' id='animalInfo'>동물 소개</a>
			...
			<div class="col">
				<br>
				<br> <a href='${ contextPath }/views/community/review.jsp'
					class='mainCateName' id='community'>커뮤니티</a>
				<div class="subCategory" id='communitySub'>
					<ul>
						<li><a href='${ contextPath }/views/community/review.jsp'>후기
								게시판</a></li>
						<li style='width: 120px;'><a
							href='${ contextPath }/views/community/book.jsp'>예약 게시판</a></li>
					</ul>
				</div>
			</div>
			<div class="col">
				<br>
				<br> <a href='${ contextPath }/views/cs/FAQ.jsp'
					class='mainCateName' id='cs'>고객 센터</a>
				<div class="subCategory" id='csSub'>
					<ul>
						<li style='width: 150px;'><a
							href='${ contextPath }/views/cs/FAQ.jsp'>자주 묻는 Q&A</a></li>
						<li style='width: 120px;'><a
							href='${ contextPath }/views/cs/question.jsp'>문의 게시판</a></li>
					</ul>
				</div>

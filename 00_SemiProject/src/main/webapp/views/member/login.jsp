		  ...
		  <div class="row">
		    ...
		    <div class="col-9">
		    	...
		    	<div class="row g-3 align-items-center">
				  ...
				  <div class="col-7">
				    <input type="text" class="form-control-lg" id="inputId" placeholder="아이디를 입력하세요" size='50'>
				  </div>
				...
				<div class="row g-3 align-items-center">
				  ...
				  <div class="col-7">
				    <input type="email" class="form-control-lg" id="inputEmail" placeholder="이메일를 입력하세요" size='50'>
				  </div>
				  <div class="col-auto"></div>
				</div>
				<div class='marginDiv'></div>
				...
				<div class="row g-3 align-items-center">
				  ...
				  <div class="col-7">
				    <input type="password" id="inputPassword" class="form-control-lg" aria-describedby="passwordHelpInline" placeholder="비밀번호를 입력하세요" size='50'>
				  </div>
				  <div class="col-auto"></div>
				</div>
				<div class="row g-3 align-items-center">
				...
				<div class="row g-3 align-items-center">
				  ...
				  <div class="col-7">
				    <input type='text' class="form-control-lg" id="inputPhone" placeholder='핸드폰 번호를 입력하세요' size='50'>
				  </div>
				  <div class="col-auto">
				  </div>
				</div>

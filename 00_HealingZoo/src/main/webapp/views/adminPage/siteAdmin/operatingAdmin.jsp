	...
	<div class="container" style="width: 900px; margin-top: 100px; margin-bottom: 30%;">
		...
		<div  style='margin-bottom: 100px;'>
			...
			<div class='row'>
				...
				<div class='col-3'>
					<button id='chargeImg' class="btn" style='background: #EA862A; color: white;'>수정</button>
			    	&nbsp;&nbsp;&nbsp;	
					<button id='chargeImg' type="button" class="btn" style='background: #DD5353; color: white;'>삭제</button>
				</div>
			</div>
		</div>
	</div>

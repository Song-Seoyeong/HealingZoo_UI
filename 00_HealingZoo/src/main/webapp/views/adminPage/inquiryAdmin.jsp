...
<style>
	...
	.complete { color: #65B741; }
	.Incomplete { color: #EA862A; }
...
<body>
	...
	<ul class="nav flex-column" style="float: left; margin-top: 100px; margin-left: 50px;">
	  ...
	  <li class="nav-item">
	    <a class="nav-link" href="#" style="border-bottom: 1px solid #B9B9B9; color: black;' font-wieght: bold; ">공지사항</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link active" aria-current="page" href="#" style="border-bottom: 1px solid #B9B9B9; color: #65B741;">문의사항</a>
	  </li>
	  <li class="nav-item">
	...
	<div class="container" style="width: 900px; margin-top: 100px;">
		...
		<div class="row justify-content-center" style="margin-bottom: 100px;">
			<div class="col-4">
				<select class="form-select" aria-label="Default select example" style="display:inline-block; float: right; width: 200px;">

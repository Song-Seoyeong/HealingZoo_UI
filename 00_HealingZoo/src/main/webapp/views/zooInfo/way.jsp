...
<head>
    ...
    <style>
        ...
        .waycontainer {
            ...
            padding: 80px 130px;
            /*box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); 구역 배정을 위한 임시 선*/
        }
        ...
        .way-bar {
            width: 1px; /* 전체 너비를 사용 */
		    height: 550px; /* 전체 높이를 사용 */
		    margin: 0; /* 중앙 정렬을 없애기 위해 마진 제거 */
		    box-sizing: border-box; /* 패딩 포함 */
		    background-color: #fff;
		    border: 2px solid #ffffff; /* 원하는 색상으로 변경 */
        }
        .way-bar2 {
            width: 1px; /* 전체 너비를 사용 */
		    height: 550px; /* 전체 높이를 사용 */
		    margin: 20; /* 중앙 정렬을 없애기 위해 마진 제거 */
		    box-sizing: border-box; /* 패딩 포함 */
		    background-color: #fff;
		    box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);
		    border: 2px solid #006400; /* 원하는 색상으로 변경 */
        ...
        <div class="waycontent">
        	<div class="waymap">
	            ...
	            <br>
		            ...
		            동물원 주소 : <span class="waytext">서울특별시 중구 을지로 광교 앞 그레이츠 청계</span></div>
     			</div> 

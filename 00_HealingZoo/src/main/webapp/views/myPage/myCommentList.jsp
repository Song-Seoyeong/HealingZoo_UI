...
<body>
	...
	<ul class="nav flex-column" style="float: left; margin-top: 100px; margin-left: 50px;">
	  ...
	  <li class="nav-item">
	    <a class="nav-link" href="${ contextPath }/views/myPage/myComment.jsp" style="border-bottom: 1px solid #B9B9B9; color: #65B741; font-wieght: bold">내 댓글 보기</a>
	  </li>
	</ul>
	...
	<div class="container" style="width: 900px; margin-top: 100px;  ">
		...
		<table class="table">
		  <thead>
		    <tr>
		      <th scope="col" style="width:100px;"><input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></th>
		      <th scope="col">내용</th>
		      <th scope="col">원문</th>
		    </tr>
		  </thead>
